** Possible workflow/script for starting a coupled flowvr/ray app. 
 ...
 3. <span style="color:red"> Allow Ray to manage all resources as a single pool of machines, each entity can be use then either for doing compution as a ray actor or simply for the simulator</span>
